...
@event_router.post("/event", response_model=ShowEvent)
...
@event_router.get("/event/{event_id}", response_model=ShowEvent)
...
@event_router.patch("/archive_event/{event_id}")
...
@event_router.patch("/event/{event_id}", response_model=UpdateEventResponse)
